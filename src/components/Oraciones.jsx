...
export default function Misterio({num}) {
    ...
    const misterios = {
        Gozosos: {
            1: `1. La anunciacion
                «Al sexto mes el angel Gabriel fue enviado por Dios a una ciudad de Galilea, llamada Nazaret, a una virgen desposada con un hombre llamado Jose, de la estirpe de David, el nombre de la virgen era Maria.» 
                (Lc 1, 26-27)`,
    ...
    return(
        <Body>
            ...
            <p>
                ...
                y socorre espelcialmente a las más necesitadas de tu Divina Misericordia. Amén.
            </p>
            <p>
